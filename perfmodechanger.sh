...
read choice
if [[ $choice == "0" ]] ; then ; echo 0 > /sys/devices/virtual/thermal/thermal_message/sconfig ; fi
if [[ $choice == "1" ]] ; then ; echo 10 > /sys/devices/virtual/thermal/thermal_message/sconfig ; fi
if [[ $choice == "2" ]] ; then ; echo 20 > /sys/devices/virtual/thermal/thermal_message/sconfig ; fi
if [[ $choice -ne "0" ]] || [[ $choice -ne "1" ]] || [[ $choice -ne "2" ]] ; then ; echo "wrong choice try again" ; fi
profiler ; echo "Power profile changed to $profile"
exit 1
fi

#Arguments Mode, to switch plans fast
if [[ $1 == "0" ]] ; then ; echo 0 > /sys/devices/virtual/thermal/thermal_message/sconfig ; fi
if [[ $1 == "10" ]] ; then ; echo 10 > /sys/devices/virtual/thermal/thermal_message/sconfig ; fi
if [[ $1 == "20" ]] ; then ; echo 20 > /sys/devices/virtual/thermal/thermal_message/sconfig ; fi
